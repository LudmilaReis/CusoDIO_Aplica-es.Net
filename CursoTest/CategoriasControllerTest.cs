...
namespace CursoTest
{
    public class CategoriasControllerTest
    {
        ...
        public CategoriasControllerTest()
        {
            ...
            _mockContext.Setup(expression: m => m.Categorias.FindAsync(1)).ReturnsAsync(_categoria);
        ...
        public async Task Put_Categoria()
        {
            ...
            await service.PutCategoria(id: 1, _categoria);

            _mockContext.Verify(expression: m => m.SaveChangesAsync(It.IsAny<CancellationToken>()), Times.Once());
        ...
        public async Task Delete_Categoria()
        {
            ...
            await service.DeleteCategoria(id: 1);

            _mockSet.Verify(expression: m => m.FindAsync(1), Times.Once());
            _mockSet.Verify(expression: x => x.Remove(_categoria), Times.Once);
            _mockContext.Verify(expression: m => m.SaveChangesAsync(It.IsAny<CancellationToken>()), Times.Once());
        }
    }
}   
